...
module aes_encryption #(
  ...
  wire [TDATA_WIDTH-1:0] aes_in_swapped;

  assign aes_in_swapped = {<<8{aes_in_tdata}};
  assign stage_data[0]  = aes_in_swapped ^ round_keys[0];
  assign stage_valid[0] = aes_in_tvalid;
  assign stage_last[0]  = aes_in_tlast;
  assign aes_in_tready = round_keys_valid & stage_ready[0];

  assign aes_out_tdata = {<<8{stage_data[ROUND_NUMBER]}};
