...
def key_expansion(key):
    ...
    round_keys_raw = [key_schedule[4*i : 4*(i+1)] for i in range(n_r+1)]

    return ["".join(f"{b:02X}" for word in rk for b in word)
            for rk in round_keys_raw]
